...
<jsp:useBean id="listaPaises" scope="request" type="java.util.ArrayList<com.example.laboratorio10.Beans.Country>"/>
<jsp:useBean id="location" scope="request" type="com.example.laboratorio10.Beans.Location"/>
<!DOCTYPE html>
<html>
    <head>
