...
<%@ page import="com.example.laboratorio10.Beans.Location" %>
<%@page contentType="text/html" pageEncoding="UTF-8" %>
<jsp:useBean id="listaLocations" scope="request" type="java.util.ArrayList<com.example.laboratorio10.Beans.Location>"/>
<jsp:useBean id="listaEmpleados" scope="request" type="java.util.ArrayList<com.example.laboratorio10.Beans.Employee>"/>
<jsp:useBean id="department" scope="request" type="com.example.laboratorio10.Beans.Department"/>
<!DOCTYPE html>
<html>
    <head>
